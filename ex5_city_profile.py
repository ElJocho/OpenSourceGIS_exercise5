...
def main():
    ...
    path_data = "C:\Users\jocho\Desktop\opengis\ue5\OpenSourceGIS_exercise5\data"

    # 0. Adjust the region of the mapset to your city ---------------------------

    # Create new layer containting the selected district
    gscript.run_command('v.extract', input='cities@PERMANENT', where="name='AK19'", output='studyarea')
